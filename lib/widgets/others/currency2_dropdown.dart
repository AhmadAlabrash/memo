...
abstract class DropdownsModel {
  String get title;
  String get img;
}

class Currency2DropDown<T extends DropdownsModel> extends StatefulWidget {
  final String hint;
  final String title;
...
class _CustomDropDownState<T extends DropdownsModel>
    extends State<Currency2DropDown<T>> {
  T? _selectedItem;
